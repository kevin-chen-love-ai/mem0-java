...
public class MockEmbeddingProviderTest {
    ...
    void testGetDimensions() {
        assertEquals(1536, embeddingProvider.getDimensions());
    }
    ...
    void testBatchEmbed() throws Exception {
        ...
        List<List<Float>> embeddings = embeddingProvider.batchEmbed(texts).get(5, TimeUnit.SECONDS);
    ...
    void testBatchEmbedEmpty() throws Exception {
        ...
        List<List<Float>> embeddings = embeddingProvider.batchEmbed(emptyList).get(5, TimeUnit.SECONDS);
